		...
		<div class="col">
			...
			<div class="collapse" id="collapseExample">
				<div class="card card-body">
					<form action="../funciones/agregarCotizaciones.php" method="POST">
						<div class="row">
			...
			$pagos = $conexion->query("SELECT * FROM cotizaciones");
				...
				<table style="margin-top:10px;" class="table table-hover">
					...
					<tbody>
						...
						if (isset($_POST['dateFrom']) && isset($_POST['dateTo'])) {
							$total = $conexion->query(" SELECT sum(valor) as TotalValor FROM cotizaciones WHERE fecha>='$dateFrom' and fecha<='$dateTo'");
						...
						?>
									<tr>
										...
										<td><a href="../funciones/eliminarCotizaciones.php?idCotizaciones=<?php echo $datos["idCotizaciones"]; ?>"><button type="button" class="btn btn-danger"><i class="far fa-trash"></i></button></a>
											<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ModalEditar-<?php echo $datos["idCotizaciones"]; ?>">
												<i class="far fa-edit"></i>
											</button>

											<div class="modal fade" id="ModalEditar-<?php echo $datos["idCotizaciones"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form id="editar-<?php echo $datos["idCotizaciones"]; ?>" action="../funciones/modificarCotizaciones.php" method="POST">
																<div class="row">
																	...
																	<div class="col col-12 col-md-6 col-sm-12 mt-2">
																		<input type="hidden" name="idCotizaciones" value="<?php echo $datos["idCotizaciones"]; ?>">
														...
														<div class="modal-footer">
															<button form="editar-<?php echo $datos["idCotizaciones"]; ?>" type="submit" class="btn btn-warning"><i class="far fa-save"></i> ACTUALIZAR</button>
														</div>
													</div>
												</div>
											</div>
